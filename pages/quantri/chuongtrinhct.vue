        ...
        <div class="columns">
          <div class="column">
            <div class="control">
              ...
              <span style="color: #3850b7; font-size: 17px; font-weight: bold"
                >Bảng theo dõi thực hiện nhiệm vụ tháng 10/2023</span
              >
            </div>
          </div>
  ...
  data() {
    return {
      form_Add_Data: {
        ...
        dathuchien: "",
        malinhvuc: "1",
        linhvuc: "Thực hiện nhiệm vụ tháng",
        createdAt: null,
      },
  ...
  methods: {
    ...
    async onAdd() {
      ...
      const response = await this.$store.dispatch(
        "modules/linhvuc1/createChuongtrinhct",
        data
      );
    ...
    async onUpdate() {
      ...
      if (result.isConfirmed) {
        try {
          ...
          // cập nhật dữ liệu
          const response = await this.$store.dispatch(
            "modules/linhvuc1/updateChuongtrinhct",
            payload
          );
    ...
    async onDelete(data) {
      ...
      if (result.isConfirmed) {
        try {
          const response = await this.$store.dispatch(
            "modules/linhvuc1/deleteChuongtrinhct",
            data
          );
          if (response.success == true) {
            const Toast = Swal.mixin({
